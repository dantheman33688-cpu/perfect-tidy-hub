...
const fetchYouTubeVideos = async (level)=>{
    const thumbnail = "/images/thumbnails/perfect-tidy-level-".concat(level, "-game-walkthrough.webp"); // 使用本地图片  
    return {
        thumbnail: thumbnail,
...
function LevelSelector() {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])(); // 👈 新增
    ...
    const handleSearch = (e)=>{
        ...
        if (searchTerm) {
            ...
            if (!isNaN(levelNum) && levelNum >= 1 && levelNum <= 728) {
                router.push("/levels/".concat(levelNum)); // 👈 直接跳到详情
                return;
            }
            // 不是纯数字则按标题过滤
    ...
    const filteredLevels = getLevelsToDisplay().filter((level)=>{
        var _levelsData_level;
        if (!searchTerm) return true;
        return level.toString().includes(searchTerm) || ((_levelsData_level = levelsData[level]) === null || _levelsData_level === void 0 ? void 0 : _levelsData_level.title.toLowerCase().includes(searchTerm.toLowerCase()));
    });
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(LevelSelector, "HQsQ4ucJWpzRG+WOPLr6ibWBJ3o=", false, function() {
    return [
...
//# sourceMappingURL=src_components_8c129abe._.js.map