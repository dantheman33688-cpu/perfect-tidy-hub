...
;
// PrevNext 组件
function PrevNext({ currentLevel, levels }) {
    ...
    const Box = ({ item, label })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"], {
            href: `/levels/${item?.id}`,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-4",
        children: [
            prevLevel && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(Box, {
                item: prevLevel,
            ...
            nextLevel && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(Box, {
                item: nextLevel,
                label: "Next Level"
            }, void 0, false, {
                fileName: "[project]/src/components/LevelDetail.tsx",
...
// AdjacentGrid 组件
function AdjacentGrid({ currentLevel, levels }) {
    const adjacentLevels = generateAdjacentLevels(currentLevel, levels, 12);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "grid grid-cols-4 gap-3",
        children: adjacentLevels.map((level)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"], {
                href: `/levels/${level.id}`,
                className: `flex items-center justify-center h-12 rounded-lg border-2 text-sm font-medium transition-all ${level.id === currentLevel ? "bg-blue-100 border-blue-500 text-blue-700 shadow-sm" : "bg-white border-gray-300 text-gray-700 hover:bg-gray-50"}`,
                children: level.id
            }, level.id, false, {
                fileName: "[project]/src/components/LevelDetail.tsx",
                lineNumber: 47,
...
// 生成相邻关卡数据
function generateAdjacentLevels(currentLevel, levels, count = 15) {
    const levelsSet = new Set(); // 使用 Set 来确保唯一性
    const maxLevel = levels.length;
    // 随机生成关卡号，确保不重复且在有效范围内
    while(levelsSet.size < count){
        const randomLevel = Math.floor(Math.random() * maxLevel);
        if (levels[randomLevel].id !== currentLevel) {
...
const LevelDetail = ({ level, prev, next, adjacent })=>{
...
async function generateMetadata({ params }) {
    ...
    return {
        ...
        twitter: {
            ...
            description: `Complete walkthrough and solutions for Hexa Sort level ${id}. Find tips and strategies to master this level and progress through the game.`,
            images: [
                `https://www.hexasortlevel.com/images/level-${id}-twitter.jpg`
            ]
        },
        robots: {
            index: true,
...
function Page({ params }) {
    ...
    if (!level) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "p-8",
